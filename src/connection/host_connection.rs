...
impl HostConnectionInfo {
    ...
    pub fn localhost_as_user(username: &str, password: Option<String>) -> HostConnectionInfo {
        match password {
    ...
    pub fn ssh2_with_username_password(username: &str, password: &str) -> HostConnectionInfo {
